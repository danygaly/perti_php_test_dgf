...
--
-- Host: localhost    Database: examen_php_dgf
-- ------------------------------------------------------
...
CREATE TABLE `usuarios` (
  ...
  `notas` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
--
-- Dumping routines for database 'examen_php_dgf'
--
...
-- Dump completed on 2022-05-20 19:42:38
